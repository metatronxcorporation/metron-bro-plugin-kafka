...
1. Install the plugin using `zkg install`.
    ...
    ```
    $ zkg install metatroncorporation/metron-bro-plugin-kafka --version master
    The following packages will be INSTALLED:
      zeek/metatroncorporation/metron-bro-plugin-kafka (master)

    Verify the following REQUIRED external dependencies:
    (Ensure their installation on all relevant systems before proceeding):
      from zeek/metatroncorporation/metron-bro-plugin-kafka (master):
        librdkafka ~1.4.2
    ...
    Running unit tests for "zeek/metatroncorporation/metron-bro-plugin-kafka"
    all 10 tests successful


    Installing "zeek/metatroncorporation/metron-bro-plugin-kafka"........
    Installed "zeek/metatroncorporation/metron-bro-plugin-kafka" (master)
    Loaded "zeek/metatroncorporation/metron-bro-plugin-kafka"
    ```

1. Run the following command to ensure that the plugin was installed successfully.

    ```
    $ zeek -N metatroncorporation::Kafka
...
```
@load packages/metron-bro-plugin-kafka/metatroncorporation/Kafka
